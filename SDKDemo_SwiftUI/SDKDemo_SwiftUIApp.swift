...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate, MessagingDelegate {
    ...
    public func setUser() {
        let user = NetAloUserHolder(id: 4785074617709101,
                                    phoneNumber: "ipa\\sondh.netacom",
                                    email: "",
                                    fullName: "Son Do Hoang (iOS-NETACOM)",
                                    avatarUrl: "",
                                    session: "07695bab08ee7d4a42e9b3445720351bc6c7M62Q")
        do {
