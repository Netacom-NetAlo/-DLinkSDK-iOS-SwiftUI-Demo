...
# ======================================GROUP PODS==========================================
def netalo_pods
  pod 'NetacomSDKs', :git => 'https://github.com/Netacom-NetAlo/NetaloSDKs-iOS', tag: '0.1.7'
  noti_netalo_pods
end

def noti_netalo_pods
  pod 'NotificationSDK', :git => 'https://github.com/Netacom-NetAlo/NotiSDKs-iOS', tag: '0.1.7'
